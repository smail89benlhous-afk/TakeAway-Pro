...
// GET /api/products — catalogue public (pas de connexion requise). Les restaurants et invités ne
// reçoivent que les produits visibles ; l'admin (?all=1 avec un token admin) reçoit aussi les
// produits masqués, pour la console de gestion.
