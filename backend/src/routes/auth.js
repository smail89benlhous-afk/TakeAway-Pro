...
router.post("/register", (req, res) => {
    ...
    const result = db.prepare(`
        INSERT INTO accounts (role, business_type, business_name, manager_name, phone, email, password_hash, city, address)
        VALUES ('restaurant', ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(businessType || "AUTRE", businessName, managerName, phone, email || null, passwordHash, city, address);
