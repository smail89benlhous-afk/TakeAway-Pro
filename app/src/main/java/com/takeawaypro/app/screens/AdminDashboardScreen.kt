    ...
    Scaffold(
        ...
        Column(
            ...
            Row(horizontalArrangement = Arrangement.spacedBy(10.dp)) {
                StatCard("Commandes", "${appData.todayOrderCount}", Modifier.weight(1f))
                StatCard("Clients", "${appData.todayClientCount}", Modifier.weight(1f))
            }
            Spacer(Modifier.height(10.dp))
            Row(horizontalArrangement = Arrangement.spacedBy(10.dp)) {
                StatCard("Produits", "${appData.todayProductCount}", Modifier.weight(1f))
                StatCard("Chiffre d'affaires", String.format("%.0f DH", appData.todayRevenue), Modifier.weight(1f))
            }
