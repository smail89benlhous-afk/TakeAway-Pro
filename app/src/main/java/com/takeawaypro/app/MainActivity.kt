...
private object Routes {
    ...
    const val ADMIN_RESTAURANT_DETAIL = "admin/restaurants/{name}"
    fun adminRestaurantDetail(name: String) = "admin/restaurants/${encode(name)}"
                ...
                composable(Routes.REGISTER) {
                    RegisterScreen(
                        ...
                        onAccountCreated = { account ->
                            appData.registerAccount(account)
                            navController.navigate(Routes.HOME) {
                                popUpTo(Routes.WELCOME) { inclusive = true }
                            }
                        }
                ...
                composable(Routes.ADMIN_RESTAURANTS) {
                    AdminRestaurantsScreen(
                        ...
                        onOpenRestaurant = { name ->
                            navController.navigate(Routes.adminRestaurantDetail(name))
                        }
                    )
                }
